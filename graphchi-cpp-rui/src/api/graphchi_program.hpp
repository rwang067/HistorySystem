...
namespace graphchi {
    ...
    public:
         ...
         * Update function.
         */
        virtual void updateByVertex(vertex_t &v, walkManager &walk_manager,graphchi_context &gcontext)  = 0;    
        virtual void updateByWalk(std::vector<graphchi_vertex<VertexDataType, EdgeDataType> >&vertices, vid_t vid, int sub_interval_st, int sub_interval_en, walkManager &walk_manager, graphchi_context &gcontext) = 0;
        
        virtual void startWalks( walkManager &walk_manager)  = 0;    
    };
