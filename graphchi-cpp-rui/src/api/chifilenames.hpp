...
#define VARIABLE_IS_NOT_USED
    ...
    static int find_shards(std::string base_filename, std::string shard_string="auto") {
        ...
        size_t blocksize = 1024 * 1024; //byte
        while (blocksize % sizeof(EdgeDataType) != 0) blocksize++; //  EdgeDataType=4
        //std::cout << "sizeof(EdgeDataType)  , blocksize: " << sizeof(EdgeDataType) << " " << blocksize  << std::endl;
